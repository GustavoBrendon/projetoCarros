let listaCarro = [
  ...
  },
  {
    ...
    descricao:
      "O nome P72 deriva do protótipo P70 que De Tomaso projetou para produzir com Carroll Shelby em 1964, mas que nunca foi concluído. O P70 foi nomeado assim pelo motor V8 de 7,0 litros que teria. O P72 recebe esse nome porque é a forma de homenagear esse design.",
  },
  {
  ...
  },
  {
    ...
    descricao:
      " O modelo traz um V8 4.0 de 815 cv que, em conspiração com os seus escassos 1.148 kg, permite fazer de 0 a 100 km/h em 2,8 segundos e 0 a 200 km/h em 6,8 segundos.",
  },
  {
    nome: "Czinger 21C",
...
function zoomImg(posicao) {
  ...
  document.getElementById("descCarro").innerHTML = carroSelecionado.descricao;
